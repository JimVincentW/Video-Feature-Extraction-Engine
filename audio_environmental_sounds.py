...
def lemme_see(audio_path, top_n=1):
    ...
    class_names = ["[crowd cheering]", "[person narrating]", "[whisteling]", "[cat]", "[people talking]", "[conversational]", "[cheering]", "[singing]", "[music]", "[crowd]", "[fireworks]", "[wind]", "[cow]", "[sea_waves]", "[thunderstorm]", "[keyboard_typing]", "[water_drops]", "[engine]", "[frog]", "[rain]", "[stadium]", "[cheering]", "[insects]", "[sheep]", "[sneezing]", "[door_wood_creaks]", "[chainsaw]", "[pig]", "[crackling_fire]", "[laughing]", "[chirping_birds]", "[brushing_teeth]", "[car_horn]", "[can_opening]", "[breathing]", "[crow]", "[siren]", "[airplane]", "[crickets]", "[snoring]", "[train]", "[dog]", "[drinking_sipping]", "[hen]", "[clock_tick]", "[church_bells]", "[hand_saw]", "[clock_alarm]", "[crying_baby]", "[toilet_flush]", "[clapping]", "[helicopter]", "[pouring_water]", "[coughing]", "[glass_breaking]", "[mouse_click]", "[washing_machine]", "[door_wood_knock]", "[footsteps]", "[rooster]", "[applause]", "[gunshots]", "[car_engine_revving]", "[telephone_ringing]", "[baby_cooing]", "[footsteps_on_gravel]", "[hammering]", "[whistling]", "[skateboarding]", "[keyboard_clicking]", "[chains_rattling]", "[whip_cracking]", "[children_playing]", "[paper_rustling]", "[bike_bell_ringing]", "[bell_tolling]", "[glass_clinking]", "[metal_clanging]", "[water_splashing]", "[pencil_scratching]", "[wood_sawing]", "[ice_cracking]", "[church_choir_singing]", "[street_performers]", "[street_traffic]", "[boat_horn_blowing]", "[typing_on_a_touch_screen]", "[door_slamming]", "[fingers_snapping]", "[cow_mooing]", "[horse_neighing]", "[wind_chimes]", "[gong_ringing]", "[thunder_clapping]", "[construction_noise]", "[car_alarm_sounding]", "[roaring_lion]", "[whale_singing]", "[train_whistle_blowing]", "[dog barking]"]
